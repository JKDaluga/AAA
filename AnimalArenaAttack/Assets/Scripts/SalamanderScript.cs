    ...
    void FixedUpdate()
    {
        ...
        if (health > 0)
        {
            ...
            else
            {
                gameObject.layer = 8;
                //Ability 1 Player 2
                if (((Input.GetKeyDown(KeyCode.N)) || (Input.GetKeyDown(KeyCode.Mouse0)) || Input.GetKeyDown(KeyCode.RightBracket)))
                {
            ...
            //Ability 2 Player 2
            if ((Input.GetKeyDown(KeyCode.M)) || (Input.GetKeyDown(KeyCode.Alpha6)) && isVulnerable)
            {
